...
//		eg: response.then().assertThat().body("places[0].'place name'",equalTo(cityName));
        ...
        response.then().assertThat().body(jsonPathOfValue, Matchers.equalTo(expectedValue));
...
//		eg : response.then().assertThat().body("places.'place name'", hasItem(expectedValue));
        ...
        response.then().assertThat().body(jsonPathOfValue, Matchers.hasItem(expectedValue));
    }
...
//		eg : response.then().assertThat().body("places.'place name'", hasSize(size));
        response.then().assertThat().body(jsonPathOfValue, Matchers.hasSize(size));
    }
}